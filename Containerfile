...
RUN apt update && \
    ...
    curl cmake ccache ninja-build clang clang-tools libgtk-3-dev ninja-build git && \
    git clone --recurse-submodules https://github.com/hedge-dev/UnleashedRecomp.git /src/unleashedrecomp && \
